...
import newsLetter from "@/app/lib/newsletters.json";
import { CensusReport } from "@/app/lib/mockCensusReports";

export default function NewsletterPage() {

  const reports: CensusReport[] = (newsLetter as Array<{
    id: string;
    title: string;
    description: string;
    year?: number;
      ...
      <section className="relative overflow-hidden py-10 sm:py-12">
        ...
        <div className="mx-auto w-full max-w-6xl px-4 sm:px-6 lg:px-8">
          ...
          <p className="mt-4 max-w-3xl text-slate-600 leading-relaxed">
            Browse newsletter publications that guide the
        ...
        <div className="mx-auto w-full max-w-6xl px-4 sm:px-6 lg:px-8">
          ...
          >
            <ReportsGrid
              ...
              filePrefix="publications/newsletter/"
            />
          </Suspense>
        </div>
      </section>
