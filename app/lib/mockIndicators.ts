...
export const indicatorSeries: Record<Indicator, Series> = {
  ...
  PBCI: {
    ...
    unit: "%",
    data: [
      { period: "Jan", value: 4.0 },
      { period: "Feb", value: 4.1 },
      { period: "Mar", value: 4.2 },
      { period: "Apr", value: 4.3 },
      { period: "May", value: 4.1 },
      { period: "Jun", value: 4.2 },
      { period: "Jul", value: 4.3 },
      { period: "Aug", value: 4.2 },
      { period: "Sep", value: 4.1 },
      { period: "Oct", value: 4.2 },
      { period: "Nov", value: 4.3 },
      { period: "Dec", value: 4.2 },
    ],
  },
  IIP: {
