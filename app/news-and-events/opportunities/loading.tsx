    ...
    <div className="bg-white py-10 sm:py-12">
      <div className="mx-auto w-full max-w-6xl px-4 sm:px-6 lg:px-8">
        ...
        <div className="mt-3 rounded-2xl border border-[#241B5A]/20 bg-[#241B5A] p-6 text-white sm:p-8">
          <h1 className="text-3xl font-extrabold sm:text-4xl">Career and Job Opportunities</h1>
          <p className="mt-2 text-sm text-white/85 sm:text-base">Loading opportunities...</p>
        </div>
